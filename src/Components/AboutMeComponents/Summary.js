            ...
            <CardTemplate title="Summary">
                <div>
                    <div style={{ padding: 10 }}>
                        <p style={{ color: "red", textTransform: "uppercase", fontSize: 24, paddingBlockStart: 10, paddingBlockEnd: 10 }}>Experience</p>
                    ...
                    <div style={{ padding: 10 }}>
                        <p style={{ color: "red", textTransform: "uppercase", fontSize: 24, paddingBlockStart: 10, paddingBlockEnd: 10 }}>Application Project</p>
                    ...
                    <div style={{ padding: 10 }}>
                        <p style={{ color: "red", textTransform: "uppercase", fontSize: 24, paddingBlockStart: 10, paddingBlockEnd: 10 }}>Short Target</p>
                    ...
                    <div style={{ padding: 10 }}>
                        <p style={{ color: "red", textTransform: "uppercase", fontSize: 24, paddingBlockStart: 10, paddingBlockEnd: 10 }}>Personality</p>
                        <p>- Challenging.</p>
                        <p>- High passion.</p>
