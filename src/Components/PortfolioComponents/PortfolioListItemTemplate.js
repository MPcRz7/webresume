    ...
    render() {
        ...
        return (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: 30, width: "420px" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", marginBlock: 10, width: "100%" }}>
                    ...
                    <div style={{ gridColumn: 3, display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start" }}>
                        <div style={{ paddingBlock: 5, paddingInline: 10, borderRadius: 5, border: "2px solid red" }}>
                            <p style={{ fontSize: 12, color: "red" }}>{workingType}</p>
                        </div>
                    </div>
                </div>
                <div style={{ marginBlock: 5, display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <p style={{ fontSize: 24 }}>{appName}</p>
                    <p style={{ fontSize: 18 }}>[{framework}]</p>
                </div>
                {/* <p style={{ fontSize: 14, marginBlock: 5 }}>{description}</p> */}
                <div>
                    <p>
