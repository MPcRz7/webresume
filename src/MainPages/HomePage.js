        ...
        <body className="home">
            <LayoutTemplate headerHeight={headerHeight} footerHeight={footerHeight} bodyHeight={bodyHeight}>
                <div style={{ display: "grid", gridTemplateRows: "1fr 1fr", gridTemplateColumns: "4fr 6fr", height: "100%", minHeight: bodyHeight }}>
                    ...
                    <div style={{ gridRow: "1", gridColumn: "2", display: "flex", flexDirection: "column", justifyContent: "center", paddingInlineStart: 20, paddingInlineEnd: 20 }}>
                    ...
                    <div style={{ gridRow: "2", gridColumn: "2", paddingBlockStart: 30, paddingBlockEnd: 30, paddingLeft: 100, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
